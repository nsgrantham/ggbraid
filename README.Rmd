...
Now what if we filled the area between the two lines with two different colors? One color when the solid line is _above_ the dashed line, and a different color when the solid line is _below_ the dashed line.
