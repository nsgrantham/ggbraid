...
ggplot(temps, aes(x = date, y = avg, linetype = city)) +
	geom_line()
```
...
On second thought... what if we used two colors for the ribbon? We could have one color when New York is warmer than San Francisco and another color when New York is colder than San Francisco.
