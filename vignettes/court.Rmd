...
ggplot(court, aes(x = moderate(mqscore), y = year)) +
  ...
  annotate("text", x = 0, y = 2032, label = "Ideological Leaning of the US Supreme Court", fontface = "bold", size = 8) +
  annotate("text", x = 0, y = 2029, label = "Martin-Quinn scores of every justice serving since 1937", size = 5) +
  annotate("text", x = 0.95, y = 1937.5, label = "Data from mqscores.lsa.umich.edu", size = 4, hjust = 0) +
  annotate("text", x = -0.5, y = 2025, label = "← More Liberal", hjust = 1, color = "blue", size = 5, alpha = 0.6) +
  annotate("text", x = 0.5, y = 2025, label = "More Conservative →", hjust = 0, color = "red", size = 5, alpha = 0.6) +
  annotate("text", x = 0.75, y = 2021, label = "Court Median", fontface = "bold", size = 4) +
