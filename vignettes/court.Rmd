...
ggplot(court, aes(x = moderate(mqscore), y = year)) +
  ...
  annotate("text", x = 0, y = 2029, label = "Adjusted Martin-Quinn scores of every justice serving since 1937", size = 5) +
  annotate("text", x = 2.85, y = 1938.5, label = "Data from mqscores.lsa.umich.edu\nGraphic from nsgrantham.github.io/ggbraid/articles/court", size = 3, hjust = 1) +
  ...
  scale_x_continuous(limits = c(-2.85, 2.85), expand = c(0.01, 0.01)) +
